...
Route::get('/admin/product/new', 'adminController@createProduct')->name('admin.create.product');
Route::get('/admin/contact', 'adminController@showContact')->name('admin.contact');
Route::get('/admin/contact/{id}', 'adminController@editComment')->name('admin.editComment');
Route::post('/admin/product/new', 'adminController@storeUser')->name('admin.store.product');
...
Route::put('/admin/product/{id}', 'adminController@updateProduct')->name('admin.update.product');
Route::delete('/admin/product/{id}', 'adminController@destoryProduct')->name('admin.destroy.product');
Route::delete('/admin/contact/{id}', 'adminController@destroyContact')->name('admin.destroy.contact');
