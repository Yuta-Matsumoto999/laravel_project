        ...
        <div class="col-12">
          {!! Form::open(['route' => ['sale.store.contact']]) !!}
            <div class="form-group">
              ...
              {!! Form::text('name', $user->name, ['class' => 'form-control', 'id' => 'name1', 'placeholder' => 'お名前', 'readonly' ]) !!}
            </div>
            <div class="form-group">
              <label for="メールアドレス">メールアドレス</label>
              {!! Form::email('email', $user->email, ['class' => 'form-control', 'id' => 'emal1', 'placeholder' => 'example@gmail.com', 'readonly']) !!}
            </div>
